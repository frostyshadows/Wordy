...
val PaperWhite = Color(0xFFF8F7F4)
val LightGray = Color(0xFFCDC8C4)
...
// Dark mode project status colors
val SkyBlue = Color(0xFFA1CEFF)
val PaleYellow = Color(0xFFFFF0A8)
val EmeraldGreen = Color(0xFF85FC87)
